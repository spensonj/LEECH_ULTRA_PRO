...
LEECH_COMMAND = os.environ.get("LEECH_COMMAND", "leeech")
LEECH_UNZIP_COMMAND = os.environ.get("LEECH_UNZIP_COMMAND", "ext")
LEECH_ZIP_COMMAND = os.environ.get("LEECH_ZIP_COMMAND", "arch")
GLEECH_COMMAND = os.environ.get("GLEECH_COMMAND", "gleeech")
GLEECH_UNZIP_COMMAND = os.environ.get("GLEECH_UNZIP_COMMAND", "gleech_ext")
GLEECH_ZIP_COMMAND = os.environ.get("GLEECH_ZIP_COMMAND", "gleech_arch")
YTDL_COMMAND = os.environ.get("YTDL_COMMAND", "ytdll")
GYTDL_COMMAND = os.environ.get("GYTDL_COMMAND", "gytdll")
RCLONE_CONFIG = os.environ.get("RCLONE_CONFIG", "")
DESTINATION_FOLDER = os.environ.get("DESTINATION_FOLDER", "Maxx-TD")
INDEX_LINK = os.environ.get("INDEX_LINK", "")
TELEGRAM_LEECH_COMMAND = os.environ.get("TELEGRAM_LEECH_COMMAND", "tleeech")
TELEGRAM_LEECH_UNZIP_COMMAND = os.environ.get("TELEGRAM_LEECH_UNZIP_COMMAND", "tleeechunzip")
CANCEL_COMMAND_G = os.environ.get("CANCEL_COMMAND_G", "cnl")
GET_SIZE_G = os.environ.get("GET_SIZE_G", "gtsize")
STATUS_COMMAND = os.environ.get("STATUS_COMMAND", "st")
SAVE_THUMBNAIL = os.environ.get("SAVE_THUMBNAIL", "savethumb")
CLEAR_THUMBNAIL = os.environ.get("CLEAR_THUMBNAIL", "clearthumb")
UPLOAD_AS_DOC = os.environ.get("UPLOAD_AS_DOC", "Falsex")
PYTDL_COMMAND = os.environ.get("PYTDL_COMMAND", "pytdll")
GPYTDL_COMMAND = os.environ.get("GPYTDL_COMMAND", "gpytdll")
LOG_COMMAND = os.environ.get("LOG_COMMAND", "logs")
CLONE_COMMAND_G = os.environ.get("CLONE_COMMAND_G", "gclon")
UPLOAD_COMMAND = os.environ.get("UPLOAD_COMMAND", "uploada")
RENEWME_COMMAND = os.environ.get("RENEWME_COMMAND", "renewmee
")
RENAME_COMMAND = os.environ.get("RENAME_COMMAND", "renamee")
TOGGLE_VID = os.environ.get("TOGGLE_VID", "togglevideoo")
TOGGLE_DOC = os.environ.get("TOGGLE_DOC", "togglefilee")
RCLONE_COMMAND = os.environ.get("RCLONE_COMMAND", "rclonee")
HELP_COMMAND = os.environ.get("HELP_COMMAND", "helpp")
